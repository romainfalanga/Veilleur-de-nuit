(() => {
  ...
  const SCHEDULE = [
    ...
    },
    {
      ...
      desc: "Ronde intérieure + extérieure complète. Récupérer les cravates petit-déjeuner sur les poignées de porte.",
      tag: "Sécurité",
      alert: true,
    },
    {
