  ...
  const SCHEDULE = [
    {
      ...
      title: "Prise de poste — Transmission & Caisse",
      desc: "⏱ Pointer à 19h30 à l'arrivée.\nPoint avec l'équipe de jour et vérification du fond de caisse.",
    ...
    },
    {
      ...
      desc: "Mise en place du robot de nettoyage, vidage des pédiluves et vérification/rangement de l'ensemble de l'espace piscine.",
      tag: "Piscine",
      alert: true,
    },
    {
      ...
      desc: "Ronde intérieure + extérieure complète. Vérifier que toutes les portes sont bien fermées.",
      tag: "Sécurité",
      alert: true,
    },
    {
      id: "classement-reservations",
      start: "20:30",
      end: "21:00",
      title: "Classement des réservations du lendemain et tâches annexes prévues",
      desc: "Préparer et classer les réservations du lendemain. Effectuer les tâches annexes prévues.",
      tag: "Administratif",
      alert: true,
    },
    {
      ...
      title: "Réception",
      desc: "Accueil et arrivées tardives.",
      tag: "Réception",
      alert: true,
    },
    {
      ...
      title: "Vérification et classement des transferts chambres",
      desc: "Vérifier et classer les transferts chambres du bar et du restaurant.",
      tag: "Caisse",
      alert: true,
    },
    {
      ...
      title: "Récupération des tickets petit-déjeuner",
      desc: "Tour pour récupérer les tickets petit-déjeuner sur les portes des chambres et les déposer à l'espace dédié.",
      tag: "Petit-déjeuner",
      alert: true,
    },
    {
    ...
    {
      id: "impression-listes",
      start: "01:55",
      end: "02:00",
      title: "Impression listes petit-déjeuner et clients",
      desc: "Imprimer la liste petit-déjeuner et la liste des clients (raccourci F12 sur le logiciel).",
      tag: "Petit-déjeuner",
      alert: true,
    },
    {
    ...
    {
      id: "petit-dejeuner-final",
      start: "05:00",
      end: "06:00",
      title: "Finalisation du Petit-Déjeuner",
      desc: "Finalisation et dressage final du buffet avant l'arrivée des premiers clients.",
      tag: "Petit-déjeuner",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      title: "Transmission et feuille de caisse",
      desc: "Passation des consignes avec l'équipe montante.\nFaire la feuille de caisse (raccourci F12).",
      tag: "Clôture",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      title: "Fin du service",
      desc: "⏱ Pointer à 07h30 à la sortie.\nQuitter le poste après vérification finale.",
      tag: "Fin",
      alert: true,
      instant: true,
    },
