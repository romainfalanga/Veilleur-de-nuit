(() => {
  ...
  const SCHEDULE = [
    ...
    },
    {
      ...
      desc: "Avant de partir : mettre la pancarte à la réception.\nRonde intérieure + extérieure complète. Vérifier que toutes les portes sont bien fermées.",
      tag: "Sécurité",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      title: "Vérification ticket de bar",
      desc: "Fermeture du bar : vérifier les tickets et la correspondance des encaissements.",
      tag: "Caisse",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      desc: "Avant de partir : mettre la pancarte à la réception et prendre le téléphone avec soi.\nRonde intérieure + extérieure complète. Récupérer les cravates petit-déjeuner sur les poignées de porte.",
      tag: "Sécurité",
      alert: true,
    },
    {
      ...
      desc: "Vérification et clôture de la caisse (environ 15 min).",
      tag: "Caisse",
      alert: true,
    },
    {
