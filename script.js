(() => {
  ...
  const SCHEDULE = [
    ...
    },
    {
      ...
      desc: "Avant de partir : mettre la pancarte à la réception et prendre le téléphone avec soi.\nRonde intérieure + extérieure. Récupérer les cravates petit-déjeuner sur les poignées de porte.",
      tag: "Sécurité",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      title: "Ronde de sécurité n°3",
      desc: "Avant de partir : mettre la pancarte à la réception et prendre le téléphone avec soi.\nRonde intérieure + extérieure complète.",
      tag: "Sécurité",
      alert: true,
    },
    {
