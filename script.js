(() => {
  ...
  const SCHEDULE = [
    ...
    },
    {
      ...
      title: "Vérification et classement des tickets",
      desc: "Vérifier et classer les tickets de bar et les tickets de restaurant (correspondance des encaissements).",
      tag: "Caisse",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      title: "Premiers check-out",
      desc: "Accueil et départ des premiers clients de la matinée.",
      tag: "Réception",
      alert: true,
    },
    {
