(() => {
  ...
  const SCHEDULE = [
    ...
    },
    {
      ...
      desc: "Avant de partir : mettre la pancarte à la réception et prendre le téléphone avec soi.\nRonde intérieure + extérieure complète. Récupérer les cravates petit-déjeuner sur les poignées de porte. Vérifier que toutes les portes sont bien fermées.",
      tag: "Sécurité",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      desc: "Avant de partir : mettre la pancarte à la réception et prendre le téléphone avec soi.\nSeconde ronde intérieure + extérieure complète.",
      tag: "Sécurité",
      alert: true,
    },
    {
    ...
    },
    {
      ...
      desc: "Présence à la réception pour les premiers clients de la matinée.",
      tag: "Réception",
      alert: true,
    },
    {
      ...
      title: "Transmission & Clôture",
      desc: "Passation des consignes avec l'équipe montante. Vérification finale du fond de caisse.",
      tag: "Clôture",
      alert: true,
    },
    {
      ...
      desc: "Quitter le poste après passation complète.",
      tag: "Fin",
      alert: true,
      instant: true,
    },
